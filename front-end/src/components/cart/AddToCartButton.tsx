...
export default function AddToCartButton({
  ...
  /*
   * El carrito identifica líneas por variante,
   * no únicamente por producto.
   */
  ...
  const handleAddToCart =
    async () => {
      ...
      /*
       * Debe existir una variante seleccionada.
       */
      if (!variant) {
        setErrorMessage(
  ...
  return (
    <div className="mt-8">
      ...
      {errorMessage ? (
        <p
          role="alert"
          className="mt-3 rounded-lg border border-red-100 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700"
        >
          {errorMessage}
        </p>
      ) : null}
