import { Controller, Get, Post, Patch, Delete, Body, Param, Req, UseGuards, ParseUUIDPipe, BadRequestException, UnauthorizedException } from '@nestjs/common';
...
export class CustomersController {
  ...
  async getMyAddresses(@Req() req: any) {
    // Obtener las direcciones ordenadas (predeterminada primero)
    const addresses = await this.customersService.getAddresses(req.user.id);

    // Mapear al DTO público seguro de dirección
