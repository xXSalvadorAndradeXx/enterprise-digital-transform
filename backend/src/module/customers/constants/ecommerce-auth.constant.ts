 ...
 * Se define como undefined para que Express no envíe Max-Age y el navegador
 * la trate como cookie de sesión.
 */
 ...
 * permitiendo que sobreviva al cierre del navegador.
 */
 ...
 * @param maxAgeSeconds - Duración máxima de la cookie en segundos. Si es undefined, la cookie
 *                        no incluye Max-Age y el navegador la trata como cookie de sesión.
 * @param isProduction - Si el entorno es producción (Secure=true).
 */
export function buildRefreshTokenCookieOptions(
  ...
  if (maxAgeSeconds !== undefined) {
    options.maxAge = maxAgeSeconds * 1000; // Express/NestJS espera milisegundos
  }
