...
export class PaymentsController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Solicitud de pago creada exitosamente',
    type: Payment,
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Ya existe un pago registrado para esta orden',
  })
  ...
  @ApiOperation({
    summary:
      'Simular/Procesar la confirmación de pago con tarjeta de crédito/débito',
  })
  @ApiParam({ name: 'id', description: 'UUID del pago' })
  @ApiResponse({
    status: 200,
    description: 'Tarjeta procesada y estado de pago actualizado',
    type: Payment,
  })
  @ApiResponse({
    status: 400,
    description: 'Transición de estado inválida o datos de entrada incorrectos',
  })
